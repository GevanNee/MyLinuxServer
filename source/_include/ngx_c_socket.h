...
struct ngx_connection_s
{
	...
	/*发包相关*/
	std::atomic<int>		iThrowSendCount;				//用这个变量标记发送缓冲区满了
	char*					psendMemPointer;				//释放用的
...
public:
	...
	//virtual void proPingTimeOutChecking(LPSTRUC_MSG_HEADER tmpmsg, time_t cur_time); //心跳包检测函数
...
private:
	...
	pthread_mutex_t						m_connectionMutex;				//连接相关互斥量，用来互斥m_freeconnectionList，m_connectionList
